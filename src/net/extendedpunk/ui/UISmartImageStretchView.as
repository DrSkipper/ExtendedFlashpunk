package net.extendedpunk.ui 
{
	 ...
	 */
	public class UISmartImageStretchView extends UIView 
	{
		/**
		 * Constructor
		 ...
		 */
		public function UISmartImageStretchView(position:Point, size:Point, source:*) 
		{
			super(position, size);
			...
			if (normalImage != null)
			{
				...
				var halfW:uint = normalImage.width / 2;
				var halfH:uint = normalImage.height / 2;
